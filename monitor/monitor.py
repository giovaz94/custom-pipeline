...
class Logger:
    ...
    def log(self) -> None:
        ...
        init_val_completed = self._execute_prometheus_query("sum(last_over_time(message_analyzer_complete_message[10s]))")
        init_val_latency = self._execute_prometheus_query("sum(last_over_time(http_response_time_sum[10s]))")
        sl = self.sleep
        started = False
...
if __name__ == "__main__":
    ...
    prometheus_service_address = "134.209.137.14"
