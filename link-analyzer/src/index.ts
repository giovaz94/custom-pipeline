...
const port: string | 8013 = process.env.PORT || 8013;
...
createConsumerGroup('link-analyzer-stream', 'link-analyzer-queue');
listenToStream();
 

app.listen(port, () => {
    console.log(`link-analyzer launched ad http://localhost:${port}`);
});
